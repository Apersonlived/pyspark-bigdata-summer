...
if __name__ == "__main__":
    ...
    pg_p = sys.argv[6]
    spark_config = {}
    spark_config["master_ip"] = sys.argv[7]
    spark_config["driver_memory"] = sys.argv[8]
    spark_config["executor_memory"] = sys.argv[9]
    spark_config["executor_cores"] = sys.argv[10]
    spark_config["executor_instances"] = sys.argv[11]
